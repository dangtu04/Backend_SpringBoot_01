package com.dangthanhtu.example05.config;
...
public class AppConstants {
    ...
    public static final String[] PUBLIC_URLS = { "/v3/api-docs/**", "/swagger-ui/**", "/api/register/**", "/api/login", "/api/chat",
            "/api/public/products/image/**", "/api/public/products/keyword/**" };
